...
pacotes_mate="mate-desktop-environment atril engrampa eom ffmpegthumbnailer mate-themes mate-applets mate-media mate-notification-daemon mate-system-monitor pluma"
