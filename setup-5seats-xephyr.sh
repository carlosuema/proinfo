...
sed -i -e "s/@TN502_ADDRESS_0@/${tn502_endereco[0]}/g" -e "s/@TN502_ADDRESS_1@/${tn502_endereco[1]}/g" -e "s/@TN502_DISPLAY@/${tn502_display}/g" /etc/X11/xorg.conf.d/tn502-5seats.conf
...
install -m 644 etc/lightdm/lightdm.conf.d/xephyr-5seats.conf.in /etc/lightdm/lightdm.conf.d/xephyr-5seats.conf
sed -i -e "s/@TN502_DISPLAY@/${tn502_display}/g" /etc/lightdm/lightdm.conf.d/xephyr-5seats.conf
