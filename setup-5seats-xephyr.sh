...
install -m 644 etc/systemd/system/xorg@.service.d/xephyr-5seats.conf /etc/systemd/system/xorg@.service.d
=======
...
install -m 644 etc/systemd/system/x-daemon-Nseats.service.d/xephyr-5seats.conf /etc/systemd/system/x-daemon-Nseats.service.d
